...
public interface IChatMemberHandler extends ITelegramHandler {
	/**
	 ...
	 */
	boolean onChatMember(AbstractTelegramBot bot, Update update, ChatMemberUpdated chatMemberUpdated) throws TelegramApiException;
}
